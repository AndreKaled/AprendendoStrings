	...
	public static void main(String[] args) {
		...
		while(cont <= 3){
			for(int i = 0; i < quant; i++){
				...
				System.out.println("Digite uma palavra para ver a pontuação!");
				System.out.print("--> ");
				String a = s.nextLine();
				ponto[i] += pontuacaoDaPalavra(a);
				System.out.println("Sua pontuação é: " + pontuacaoDaPalavra(a));
		...
		System.out.println("O vencedor é o jogador " +jogadorMaior +" com a pontuação total de " +maior);
	}
